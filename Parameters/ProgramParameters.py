...
CLASSIFIER_NAME = 'svm'                 # Type of classifier to use. VALID: 'knn', 'cnb', 'nn', 'svm
...
SVM_CLASS_WEIGHT = 'balanced' # None - no balancing of classes, 'balanced' - automatic proportional weight adjustment
