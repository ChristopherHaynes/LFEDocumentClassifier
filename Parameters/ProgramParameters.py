# ------------------------------------------ GENERAL PARAMETERS --------------------------------------------------
LFE_DATA_FILE_PATH = "C:\\Users\\Chris\\Desktop\\Data\\LFE\\lfeDataNamesRemoved.xlsx"
...
# K-NN parameters
KNN_NEIGHBOURS = 23       # Number of neighbours used when classifying.
...
SVM_KERNEL = 'linear'            # Which kernel to use for dimensional increase. VALID: 'rbf', 'poly', 'sigmoid', 'linear'
